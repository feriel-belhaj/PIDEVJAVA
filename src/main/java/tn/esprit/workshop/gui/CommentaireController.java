...
public class CommentaireController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        utilisateurService = new ServiceUser();
                ...
                if (empty) {
                    ...
                    if (commentaire != null) {
                        if (commentaire.getUtilisateurId() == null) {
                            ...
                            try {
                                setText(utilisateurService.findById(commentaire.getUtilisateurId()).getNom());
                            } catch (Exception e) {
    ...
    private VBox createCommentBox(Commentaire commentaire) {
        ...
        if (commentaire.getUtilisateurId() == null) {
            ...
            try {
                userLabel.setText(utilisateurService.findById(commentaire.getUtilisateurId()).getNom());
            } catch (Exception e) {
    ...
    private void handlePublierCommentaire() {
        ...
        try {
            ...
            if (isAnonymousCheckbox.isSelected()) {
                ...
                try {
                    commentaire.setUtilisateurId(SessionManager.getUserId());
                } catch (Exception e) {
