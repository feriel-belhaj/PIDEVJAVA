...
public class FormationReserveeService {
    ...
    public void reserver(int formationId, int utilisateurId) throws SQLException {
        ...
        if (estDejaReservee(formationId, UserGetData.id)) {
        ...
        reserverFormation(formationId, UserGetData.id);
    }

    public void reserverFormation(int formationId, int utilisateurId) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(query)) {
            ...
            statement.setString(4, UserGetData.nom);
            statement.setString(5, UserGetData.prenom);
