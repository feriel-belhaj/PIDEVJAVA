...
public class FormationService {
    ...
    public void ajouter(Formation formation, int userId) throws SQLException {
        String query = "INSERT INTO formation (titre, description, datedeb, datefin, niveau, prix, emplacement, nbplace, nbparticipant, organisateur, duree,createur_id, image) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?)";
